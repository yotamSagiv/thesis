...
for t in np.arange(0, num_trials):
	...
	if b_X:
		basis_intercept, basis_grad = infer_ols_params(b_X, b_Y, has_intercept = True, eta=eta)
	if t_X:
		tensor_intercept, tensor_grad = infer_ols_params(t_X, t_Y, has_intercept = True, eta=eta)
